...
public class CryptoCurrencies {
    ...
    public String toString() {
        ...
        sb.append(CryptoCurrencies.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CryptoCurrencies) == false) {
            return false;
        }
        CryptoCurrencies rhs = ((CryptoCurrencies) other);
